...
const translations: Record<Language, Record<string, string>> = {
  el: {
    ...
    'paperBags.subtitle': 'Υψηλής ποιότητας χάρτινες σακούλες για επιχειρήσεις που δίνουν έμφαση στην ποιότητα και την επαγγελματική παρουσία.',
    'paperBags.sectionTitle': 'Κομψότητα & Ποιότητα',
    'paperBags.description1': 'Οι χάρτινες σακούλες μας κατασκευάζονται από υψηλής ποιότητας υλικά, προσφέροντας μια κομψή και επαγγελματική λύση συσκευασίας για την επιχείρησή σας. Κάθε σακούλα σχεδιάζεται με έμφαση στην αντοχή, τη λειτουργικότητα και την αισθητική.',
    'paperBags.description2': 'Από μικρές σακούλες για κοσμηματοπωλεία έως μεγάλες τσάντες για καταστήματα ένδυσης, προσφέρουμε εξατομικευμένες λύσεις με δυνατότητα πλήρους εκτύπωσης του λογοτύπου και των χρωμάτων σας.',
    'paperBags.featuresTitle': 'Χαρακτηριστικά Προϊόντων',
    'paperBags.feature1': 'Πλήρης εκτύπωση με το λογότυπό σας',
    'paperBags.feature2': 'Διαθέσιμα σε πολλά μεγέθη και σχήματα',
    'paperBags.feature3': 'Επιλογές λαβών: κορδόνι, ριμπόν, χάρτινες',
    'paperBags.feature4': 'Υψηλή αντοχή και ποιοτική κατασκευή',
    'paperBags.feature5': 'Ματ ή γυαλιστερό φινίρισμα',
    'paperBags.feature6': 'Επαγγελματική αισθητική και σταθερή ποιότητα',
    'paperBags.cta': 'Ζητήστε Προσφορά',
    'paperBags.applicationsTitle': 'Ιδανικές για Κάθε Κλάδο',
    'paperBags.applicationsText': 'Οι χάρτινες σακούλες μας εξυπηρετούν επιχειρήσεις από διάφορους κλάδους, προσφέροντας επαγγελματική εικόνα και σταθερή ποιότητα.',
  ...
  en: {
    ...
    'paperBags.subtitle': 'High-quality paper bags for businesses that prioritize quality and professional presentation.',
    'paperBags.sectionTitle': 'Elegance & Quality',
    'paperBags.description1': 'Our paper bags are manufactured from premium quality materials, offering an elegant and professional packaging solution for your business. Each bag is designed with emphasis on durability, functionality, and aesthetics.',
    'paperBags.description2': 'From small bags for jewelry stores to large bags for clothing retailers, we offer customized solutions with full logo and brand color printing capabilities.',
    'paperBags.featuresTitle': 'Product Features',
    'paperBags.feature1': 'Full custom printing with your logo',
    'paperBags.feature2': 'Available in many sizes and shapes',
    'paperBags.feature3': 'Handle options: rope, ribbon, paper',
    'paperBags.feature4': 'High durability and quality construction',
    'paperBags.feature5': 'Matte or glossy finish options',
    'paperBags.feature6': 'Professional aesthetics and consistent quality',
    'paperBags.cta': 'Request a Quote',
    'paperBags.applicationsTitle': 'Perfect for Every Industry',
    'paperBags.applicationsText': 'Our paper bags serve businesses across various industries, offering professional image and consistent quality.',
